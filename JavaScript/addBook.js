...
const regexAuthor =
  /^[A-ZȘȚĂÎÂ][a-zșțăîâA-ZȘȚĂÎÂ.'\-]{1,30}(\s[A-ZȘȚĂÎÂ][a-zșțăîâA-ZȘȚĂÎÂ.'\-]{1,30})+$/;
...
const addBook = () => {
  ...
  if (!regexAuthor.test(author)) {
    ...
    authorError.innerText =
      "Autorul trebuie să aibă nume si prenume sau initiale, ambele cu literă mare.";
  ...
  if(!genre) {
    ...
    genreError.innerText = "Selectați un gen."
  ...
  reader.onload = function () {
    ...
    img.onload = function () {
      ...
      if (alreadyExists) {
        ...
        addBookBtn.insertAdjacentElement("afterend", existsError);
        return;
      }
      ...
      addBookBtn.insertAdjacentElement("afterend", success);
